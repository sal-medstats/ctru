...
Once the list has been generated it can be sent to whomever is to use it.  A useful feature though is to upload it to Google Sheets for others to use and this can be acheived using the `[googlesheets](https://cran.r-project.org/web/packages/googlesheets/)` packages.
