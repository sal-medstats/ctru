...
Assuming you have read the exported `Screening_Form.csv` into a data


### Indices of Multiple Deprivation, Lower Super Output Area and Postcodes

Many studies wish to use an indicator of deprivation as a predictor variable in their analyses.
