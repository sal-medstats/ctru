            ...
            tabItems(
                tabItem(tabName = "about",
                        ...
                        fluidRow(width = 12,
                                 ...
                                 HTML("<ul>
                                        <li> Abstract common components to the sidebar (e.g. desired significance level and desired power).
                                        <li> Allow users to input real values and calculate standardised effects sizes (in terms of Cohen's D) internally for passing to the various functions.
                ...
                tabItem(tabName = "samplesize",
                        ...
                        fluidRow(width = 12,
                                 ...
                                 sliderInput(inputId = "alpha",
                                             label   = "Alpha (Two-Sided Significance Level)",
                                             value   = 0.01,
                                             min     = 0,
                                             max     = 1,
                                             step    = 0.001,
